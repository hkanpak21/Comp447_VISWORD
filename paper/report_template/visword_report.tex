...
\begin{table}[t]
\caption{Protocol-A retrieval R@10 under the Native Legible Protocol ($224 \to 224$, no downsampling) specifically comparing different I-JEPA pretraining configurations. Entries marked TBD indicate configurations not yet trained or evaluated at this resolution.}
...
\midrule
\rowcolor{cSSL} Baseline (Image-Only) & 0.054 & TBD & TBD \\
\rowcolor{cSSL} Text-Target (Title) & TBD & TBD & TBD \\
\rowcolor{cSSL} Text-Target (Body) & TBD & TBD & TBD \\
\bottomrule
\end{tabular}
\end{table}
