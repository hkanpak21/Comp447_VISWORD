...
\midrule
\multicolumn{4}{l}{\textbf{Perfect-Text Upper Bounds (Linguistic Ceiling)}} \\
BERT (mean-pool) & 0.938 & -- & -- \\
BERT (CLS) & 0.747 & -- & -- \\
\midrule
\multicolumn{4}{l}{\textbf{Visual Models}} \\
\rowcolor{cITC} CLIP ViT-B/16 & 0.736 & -- & -- \\
\rowcolor{cITC} SigLIP ViT-B/16 & 0.697 & -- & -- \\
\rowcolor{cSSL} DINOv2 ViT-B/14 (CLS) & 0.116 & -- & -- \\
\rowcolor{cSUP} ImageNet ViT-B/16 & 0.084 & -- & -- \\
\rowcolor{cSSL} I-JEPA ViT-H/14 & 0.054 & -- & -- \\
\rowcolor{cRND} Plain ViT-B/16 & 0.042 & -- & -- \\
\rowcolor{cSSL} MAE ViT-B/16 & 0.036 & 0.098$^\dagger$ & -- \\
\rowcolor{cSSL} MAE ViT-B/16 (title-masked) & -- & 0.143$^\dagger$ & -- \\
\bottomrule
